...
void CreateButtons(HWND hWnd)
{
	...
	hwndThread = CreateWindow(L"Button", L"스레드", WS_CHILD | WS_VISIBLE,
		0, 0, 0, 0, hWnd, 0, hIns, NULL);
	hwndHook = CreateWindow(L"Button", L"후킹", WS_CHILD | WS_VISIBLE,
		0, 0, 0, 0, hWnd, 0, hIns, NULL);
	hwndProfile = CreateWindow(L"Button", L"프로필", WS_CHILD | WS_VISIBLE,
		0, 0, 0, 0, hWnd, 0, hIns, NULL);
